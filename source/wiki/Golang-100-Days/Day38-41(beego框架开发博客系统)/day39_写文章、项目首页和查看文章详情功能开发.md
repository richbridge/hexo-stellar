...
<img src=".././img/WX20190521-145856@2x.png" alt="写博客功能入口">

然后进入写文章页面：
<img src=".././img/WX20190521-150025@2x.png" alt="写文章详情">
...
##### 2.1.5.1 准备测试数据
我们在数据库中插入10条数据：
<img src=".././img/WX20190522-113706@2x.png" alt="数据库的数据">
##### 2.1.5.1 页面显示数据条数配置
...
<img src=".././img/WX20190522-141320@2x.png" alt="未登录首页效果">

用户虽然没有登录，但是也是可以查看的，接下来我们点击登录按钮进行登录：
<img src=".././img/WX20190522-141446@2x.png" alt="登录后首页效果">
登录后，用户就可以有删除和修改的功能了。
...
<img src=".././img/WX20190522-141839@2x.png" alt="分页展示">
接下来，我们新增加一篇文章，点击写博客：
<img src=".././img/WX20190522-142111@2x.png" alt="编写新文章">
...
<img src=".././img/WX20190522-144626@2x.png" alt="文章详情">
...
#### 3.2.2 工具库源码
安装之后也可以到src目录下查看:
<img src=".././img/WX20190522-144232@2x.png" alt="查看工具库下载">
...
### 3.5 项目运行效果
重启项目后，然后刷新页面：
<img src=".././img/WX20190522-143848@2x.png" alt="支持Markdown语法效果">
