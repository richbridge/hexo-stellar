...
<img src="../res/django_request_response_cycle.png" style="zoom:20%;">
...
5. XFrameOptionsMiddleware - 防范点击劫持攻击中间件
   ...
   <img src="../res/click-jacking.png" style="zoom:20%;">

<img src="../res/builtin-middlewares.png" style="zoom:20%;">
...
1. RBAC - 基于角色的访问控制，如下图所示。
   ...
   <img src="../res/rbac-basic.png" style="zoom:20%;">

   <img src="../res/rbac-full.png" style="zoom:20%;">
...
<img src="../res/celery_architecture.png" style="zoom:20%;">
...
- Selenium IDE：嵌入到浏览器的插件，可以录制和回放脚本。
  ...
  <img src="../res/selenium_ide.png" style="zoom:20%;">
