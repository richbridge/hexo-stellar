...
<img src="../res/django_request_response_cycle.png">
...
5. XFrameOptionsMiddleware - 防范点击劫持攻击中间件
   ...
   <img src="../res/click-jacking.png">

<img src="../res/builtin-middlewares.png">
...
1. RBAC - 基于角色的访问控制，如下图所示。
   ...
   <img src="../res/rbac-basic.png">

   <img src="../res/rbac-full.png">
...
<img src="../res/celery_architecture.png">
