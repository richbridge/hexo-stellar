...
1. [注册域名](https://wanwang.aliyun.com/domain/)。
   ...
   <img src="../res/aliyun-domain.png">

2. [域名备案](https://beian.aliyun.com/)。

   <img src="../res/aliyun-keeprecord.png">

3. [域名解析](https://dns.console.aliyun.com/#/dns/domainList)。

   <img src="../res/aliyun-dnslist.png">

   <img src="../res/aliyun-resolve-settings.png">

4. [购买证书](https://www.aliyun.com/product/cas)。

   <img src="../res/aliyun-certificate.png">
