...
1. [注册域名](https://wanwang.aliyun.com/domain/)。
   ...
   <img src="../res/aliyun-domain.png" style="zoom:20%;">

2. [域名备案](https://beian.aliyun.com/)。

   <img src="../res/aliyun-keeprecord.png" style="zoom:20%;">

3. [域名解析](https://dns.console.aliyun.com/#/dns/domainList)。

   <img src="../res/aliyun-dnslist.png" style="zoom:20%;">

   <img src="../res/aliyun-resolve-settings.png" style="zoom:20%;">

4. [购买证书](https://www.aliyun.com/product/cas)。

   <img src="../res/aliyun-certificate.png" style="zoom:20%;">
