...
- 图像存储位置
  ...
  <img src="../res/相对路径.png" style="zoom:20%;">
...
- 字符实体（实体替换符）
  ...
  <img src="../res/字符实体.png" style="zoom:20%;">
...
- 规则、属性和值
  ...
  <img src="../res/选择器语法.png" style="zoom:20%;">

- 常用选择器

  <img src="../res/常用选择器.png" style="zoom:20%;">
...
- 文本的大小和字型(font-size / font-family)
  ...
  <img src="../res/尺寸单位.png" style="zoom:20%;">

  <img src="../res/衬线字体+非衬线字体+等宽字体.png" style="zoom:20%;">

- 粗细、样式、拉伸和装饰(font-weight / font-style / font-stretch / text-decoration)

  <img src="../res/字体样式.png" style="zoom:20%;">
...
- 盒子的边框、外边距和内边距（border /  margin / padding）
  ...
  <img src="../res/盒子模型.png" style="zoom:20%;">
...
- 网站布局
  ...
  - HTML5布局
    ...
    <img src="../res/经典布局-2.png" style="zoom:20%;">
- 适配屏幕尺寸
  - 固定宽度布局
  - 流体布局
  - 布局网格
...
<img src="../res/baidu_echarts.png" style="zoom:20%;">
...
3. 可视化
   ...
   <img src="../res/bootstrap-layoutit.png" style="zoom:20%;">