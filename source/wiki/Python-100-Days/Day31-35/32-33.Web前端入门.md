...
- 规则、属性和值
  ...
  <img src="../res/选择器语法.png">

- 常用选择器

  <img src="../res/常用选择器.png">
...
- 文本的大小和字型(font-size / font-family)
  ...
  <img src="../res/尺寸单位.png">

  <img src="../res/衬线字体+非衬线字体+等宽字体.png">

- 粗细、样式、拉伸和装饰(font-weight / font-style / font-stretch / text-decoration)

  <img src="../res/字体样式.png">
...
3. 可视化
   ...
   <img src="../res/bootstrap-layoutit.png">