...
<img src="../res/pycharm-vote-project.png" style="zoom:20%;">
...
3. 运行项目，在浏览器中访问`http://127.0.0.1:8000/admin`，输入刚才创建的超级用户账号和密码进行登录。
   ...
   <img src="../res/django-admin-apps.png" style="zoom:20%;">
...
4. 注册模型类。
   ...
   <img src="../res/django-admin-models.png" style="zoom:20%;">
...
5. 对模型进行CRUD操作。
   ...
   - 添加学科。
       ...
       <img src="../res/django-admin-add-model.png" style="zoom:20%;">

   - 查看所有学科。

       <img src="../res/django-admin-view-models.png" style="zoom:20%;">

   - 删除和更新学科。

       <img src="../res/django-admin-delete-update-model.png" style="zoom:20%;">
...
6. 注册模型管理类。
   ...
   <img src="../res/django-admin-view-models-subject.png" style="zoom:20%;">
   
   <img src="../res/django-admin-view-models-teacher.png" style="zoom:20%;">
