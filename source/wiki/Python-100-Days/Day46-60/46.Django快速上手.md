...
<img src="../res/web-application.png" style="zoom:20%;">
...
<img src="../res/http-request.png" style="zoom:20%;">

HTTP响应（响应行+响应头+空行+消息体）：

<img src="../res/http-response.png" style="zoom:20%;">
...
<img src="../res/mvc.png" style="zoom:20%;">
...
4. 用PyCharm打开创建好的Djang项目，并为其添加虚拟环境。
   ...
   <img src="../res/pycharm-django-project.png" style="zoom:20%;">
...
5. 安装项目依赖项。
   ...
   <img src="../res/pycharm-install-django.png" style="zoom:20%;">
...
6. 启动Django自带的服务器运行项目。
   ...
   <img src="../res/pycharm-django-server.png" style="zoom:20%;">

   方法二：在“Run”菜单选择“Edit Configuration”，配置运行“Python”程序运行项目（适用于专业版和社区版PyCharm）。

   <img src="../res/pycharm-python-manage.png" style="zoom:20%;">
...
7. 查看运行效果。
  ...
  在浏览器中输入`http://127.0.0.1:8000`访问我们的服务器，效果如下图所示。
   ...
   <img src="../res/django-index-1.png" style="zoom:20%;">
...
8. 修改项目的配置文件`settings.py`。
   ...
   <img src="../res/django-index-2.png" style="zoom:20%;">
...
1. 在项目目录下创建名为templates文件夹。
   ...
   <img src="../res/pycharm-django-template.png" style="zoom:20%;">
